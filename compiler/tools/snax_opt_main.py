...
from compiler.transforms.gemmini_os_to_rocc import ConvertGemminiOsToRocc
...
class SNAXOptMain(xDSLOptMain):
    def __init__(
        ...
        super().register_pass(ConvertGemminiOsToRocc.name, lambda: ConvertGemminiOsToRocc)
