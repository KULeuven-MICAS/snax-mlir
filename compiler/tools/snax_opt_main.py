...
from compiler.transforms.set_memory_layout_default import SetMemoryLayoutDefault
from compiler.transforms.set_memory_layout_robin import SetMemoryLayoutRobin
from compiler.transforms.set_memory_layout_tiled import SetMemoryLayoutTiled
...
class SNAXOptMain(xDSLOptMain):
    def __init__(
        ...
        super().register_pass(SetMemoryLayoutTiled.name, lambda: SetMemoryLayoutTiled)
        super().register_pass(
            SetMemoryLayoutDefault.name, lambda: SetMemoryLayoutDefault
        )
        super().register_pass(SetMemoryLayoutRobin.name, lambda: SetMemoryLayoutRobin)
