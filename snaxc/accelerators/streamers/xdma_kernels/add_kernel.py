...
from snaxc.accelerators.streamers.extensions.add_extension import AddExtension
...
class AddXDMA(XDMAKernel):
    ...
    required_extensions: Sequence[StreamerExtension] = (AddExtension(),)
