...
#     b_type = TensorType(i8, (k, n))
#     # b_vals = np.eye(k, n, dtype=np.int8)
...
#     )
#     parser.add_argument(
#         "--output", type=str, default=None, help="Output MLIR file path (optional, prints to stdout if not provided)"
#     )
...
def gemm(m=16, n=16, k=16):
    ...
    def func_body(_) -> None:
        ...
        result = QuantizedMatmulOp([a.result, b.result, c0.result, c0.result], [c.result])
