...
int printf(const char *fmt, ...) {
  ...
  while (*fmt) {
    ...
    case 'u':
      total += print_unsigned(va_arg(ap, unsigned int), 10, 0, width, zero_pad);
      break;
    case 'p':
      total += print_unsigned(va_arg(ap, unsigned int), 16, 0, width, zero_pad);
      break;
    case 'x':
      total += print_unsigned(va_arg(ap, unsigned int), 16, 0, width, zero_pad);
      break;
    ...
    case 'X':
      total += print_unsigned(va_arg(ap, unsigned int), 16, 1, width, zero_pad);
      break;
