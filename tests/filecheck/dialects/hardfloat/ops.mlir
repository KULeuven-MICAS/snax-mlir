...
func.func @test_mul(%a : i33, %b : i33, %c : i32) -> (i33, i33, i32, i33, i33) {
  ...
  %sint_to_rec = hardfloat.in_to_rec_fn<24,8,32>(%to_int) <{signedness=#builtin.signedness<signed>}>: (i32) -> i33
...
// CHECK-NEXT:   %sint_to_rec = hardfloat.in_to_rec_fn<24,8,32>(%to_int) <{signedness=#builtin.signedness<signed>}>: (i32) -> i33
