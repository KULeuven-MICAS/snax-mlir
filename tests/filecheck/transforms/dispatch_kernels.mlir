// RUN: snax-opt --split-input-file %s -p insert-accfg-op{accelerator=snax_alu},insert-accfg-op{accelerator=snax_gemmx},dispatch-kernels --allow-unregistered-dialect --print-op-generic | filecheck %s
...
//CHECK: library_call = "snax_gemmx_stream"
