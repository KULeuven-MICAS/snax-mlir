...
// CHECK-NEXT:   %1 = "memref.alloc"() <{alignment = 64 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<64xi32, "L1">
...
// CHECK-NEXT:   %2 = "memref.alloc"() <{alignment = 64 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<64xi32, strided<[1, 8]>, "L1">
// CHECK-NEXT:   "memref.copy"(%0, %2) : (memref<64xi32, "L3">, memref<64xi32, strided<[1, 8]>, "L1">) -> ()
// CHECK-NEXT:   "test.op"(%2) : (memref<64xi32, strided<[1, 8]>, "L1">) -> ()
// CHECK-NEXT:   "memref.copy"(%2, %0) : (memref<64xi32, strided<[1, 8]>, "L1">, memref<64xi32, "L3">) -> ()
// CHECK-NEXT: }) : () -> ()
...
// CHECK-NEXT:     %0 = "memref.alloc"() <{alignment = 64 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<64xi32, "L1">
// CHECK-NEXT:     %1 = "memref.alloc"() <{alignment = 64 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<64xi32, "L1">
// CHECK-NEXT:     %2 = "memref.alloc"() <{alignment = 64 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<64xi32, "L1">
...
"builtin.module"() ({
  "func.func"() <{"sym_name" = "simple_mult", "function_type" = (memref<?xi32, "L3">, memref<?xi32, "L3">, memref<?xi32, "L3">) -> (), "sym_visibility" = "public"}> ({
  ^0(%arg0 : memref<?xi32, "L3">, %arg1 : memref<?xi32, "L3">, %arg2 : memref<?xi32, "L3">):
    ...
    ^1(%arg3 : i32, %arg4 : i32, %arg5 : i32):
      %3 = "arith.muli"(%arg3, %arg4) : (i32, i32) -> i32
      "linalg.yield"(%3) : (i32) -> ()
    }) : (memref<?xi32, "L1">, memref<?xi32, "L1">, memref<?xi32, "L1">) -> ()
    "linalg.generic"(%0, %1, %2) <{"indexing_maps" = [affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>, affine_map<(d0) -> (d0)>], "iterator_types" = [#linalg.iterator_type<parallel>], "operandSegmentSizes" = array<i32: 2, 1>}> ({
    ^2(%arg3_1 : i32, %arg4_1 : i32, %arg5_1 : i32):
      %4 = "arith.muli"(%arg3_1, %arg4_1) : (i32, i32) -> i32
      "linalg.yield"(%4) : (i32) -> ()
...
// CHECK: "builtin.module"() ({
// CHECK-NEXT:   "func.func"() <{sym_name = "simple_mult", function_type = (memref<?xi32, "L3">, memref<?xi32, "L3">, memref<?xi32, "L3">) -> (), sym_visibility = "public"}> ({
// CHECK-NEXT:   ^0(%arg0 : memref<?xi32, "L3">, %arg1 : memref<?xi32, "L3">, %arg2 : memref<?xi32, "L3">):
// CHECK-NEXT:     %0 = "arith.constant"() <{value = 0 : index}> : () -> index
// CHECK-NEXT:     %1 = "memref.dim"(%arg0, %0) : (memref<?xi32, "L3">, index) -> index
// CHECK-NEXT:     %2 = "memref.alloc"(%1) <{alignment = 64 : i64, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?xi32, "L1">
// CHECK-NEXT:     %3 = "arith.constant"() <{value = 0 : index}> : () -> index
// CHECK-NEXT:     %4 = "memref.dim"(%arg1, %3) : (memref<?xi32, "L3">, index) -> index
// CHECK-NEXT:     %5 = "memref.alloc"(%4) <{alignment = 64 : i64, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?xi32, "L1">
// CHECK-NEXT:     %6 = "arith.constant"() <{value = 0 : index}> : () -> index
// CHECK-NEXT:     %7 = "memref.dim"(%arg2, %6) : (memref<?xi32, "L3">, index) -> index
// CHECK-NEXT:     %8 = "memref.alloc"(%7) <{alignment = 64 : i64, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?xi32, "L1">
...
"builtin.module"() ({
  ...
  ^0(%arg0 : memref<?x128xi8, "L3">, %arg1 : memref<128x128xi8, "L3">, %arg2 : memref<?x128xi32, "L3">):
    ...
    ^1(%arg3 : i8, %arg4 : i8, %arg5 : i32, %arg6 : i32, %arg7 : i32):
      ...
      "linalg.yield"(%13) : (i32) -> ()
    }) {"library_call" = "snax_gemm"} : (memref<?x128xi8, #tsl.tsl<[?, 8] -> (?, 8), [?, 8] -> (256, 1)>, "L1">, memref<128x128xi8, #tsl.tsl<[?, 8] -> (256, 1), [?, 8] -> (?, 8), offset: 64>, "L1">, i32, i32, memref<?x128xi32, #tsl.tsl<[?, 8] -> (256, 4), [?, 8] -> (?, 32)>, "L1">) -> ()
...
// CHECK-NEXT:    %7 = "memref.alloc"(%6) <{alignment = 64 : i64, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?x128xi8, #tsl.tsl<[?, 8] -> (?, 8), [?, 8] -> (256, 1)>, "L1">
// CHECK-NEXT:    %8 = "memref.alloc"() <{alignment = 64 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<128x128xi8, #tsl.tsl<[?, 8] -> (256, 1), [?, 8] -> (?, 8), offset: 64>, "L1">
