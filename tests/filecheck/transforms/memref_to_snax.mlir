...
// CHECK-NEXT:   %1 = arith.constant -9223372036854775808 : index
// CHECK-NEXT:   %2 = arith.constant 16 : index
// CHECK-NEXT:   %3 = arith.constant 4 : index
// CHECK-NEXT:   %4 = arith.muli %1, %3 : index
// CHECK-NEXT:   %5 = arith.muli %2, %4 : index
// CHECK-NEXT:   %6 = "snax.alloc"(%5, %1, %2) <{memory_space = "L1", alignment = 64 : i64}> : (index, index, index) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, i32, !llvm.array<2 x i32>, !llvm.array<2 x i32>)>
// CHECK-NEXT:   %7 = builtin.unrealized_conversion_cast %6 : !llvm.struct<(!llvm.ptr, !llvm.ptr, i32, !llvm.array<2 x i32>, !llvm.array<2 x i32>)> to memref<?x16xi32, "L1">
// CHECK-NEXT: }
...
// CHECK-NEXT:   %0 = "test.op"() : () -> index
// CHECK-NEXT:   %1 = arith.constant 8 : index
// CHECK-NEXT:   %2 = arith.constant -9223372036854775808 : index
// CHECK-NEXT:   %3 = arith.constant 2 : index
// CHECK-NEXT:   %4 = arith.constant 4 : index
// CHECK-NEXT:   %5 = arith.constant 4 : index
// CHECK-NEXT:   %6 = arith.divui %2, %5 : index
// CHECK-NEXT:   %7 = arith.constant 4 : index
// CHECK-NEXT:   %8 = arith.constant 128 : index
// CHECK-NEXT:   %9 = arith.muli %7, %8 : index
// CHECK-NEXT:   %10 = arith.constant 128 : index
// CHECK-NEXT:   %11 = arith.muli %9, %6 : index
// CHECK-NEXT:   %12 = arith.constant 16 : index
// CHECK-NEXT:   %13 = arith.constant 64 : index
// CHECK-NEXT:   %14 = arith.constant 1 : index
// CHECK-NEXT:   %15 = arith.constant 0 : index
// CHECK-NEXT:   %16 = arith.subi %3, %14 : index
// CHECK-NEXT:   %17 = arith.muli %16, %13 : index
// CHECK-NEXT:   %18 = arith.addi %15, %17 : index
// CHECK-NEXT:   %19 = arith.subi %4, %14 : index
// CHECK-NEXT:   %20 = arith.muli %19, %12 : index
// CHECK-NEXT:   %21 = arith.addi %18, %20 : index
// CHECK-NEXT:   %22 = arith.subi %6, %14 : index
// CHECK-NEXT:   %23 = arith.muli %22, %9 : index
// CHECK-NEXT:   %24 = arith.addi %21, %23 : index
// CHECK-NEXT:   %25 = arith.subi %7, %14 : index
// CHECK-NEXT:   %26 = arith.muli %25, %10 : index
// CHECK-NEXT:   %27 = arith.addi %24, %26 : index
// CHECK-NEXT:   %28 = arith.constant 4 : index
// CHECK-NEXT:   %29 = arith.addi %27, %28 : index
// CHECK-NEXT:   %30 = arith.muli %14, %29 : index
// CHECK-NEXT:   %31 = arith.constant 0 : index
// CHECK-NEXT:   %32 = arith.muli %31, %28 : index
// CHECK-NEXT:   %33 = arith.addi %30, %32 : index
// CHECK-NEXT:   %34 = "snax.alloc"(%33, %1, %2) <{memory_space = "L1", alignment = 64 : i64}> : (index, index, index) -> !llvm.struct<(!llvm.ptr, !llvm.ptr, i32, !llvm.array<2 x i32>, !llvm.array<2 x i32>)>
// CHECK-NEXT:   %35 = builtin.unrealized_conversion_cast %34 : !llvm.struct<(!llvm.ptr, !llvm.ptr, i32, !llvm.array<2 x i32>, !llvm.array<2 x i32>)> to memref<8x?xi32, #tsl.tsl<[2, 4] -> (16, 4), [?, 4] -> (?, 32)>, "L1">
// CHECK-NEXT: }
