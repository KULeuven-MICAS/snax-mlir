...
//CHECK-NEXT:     %3 = "arith.constant"() <{"value" = 32 : index}> : () -> index
//CHECK-NEXT:     %4 = "arith.constant"() <{"value" = 16 : index}> : () -> index
//CHECK-NEXT:     %5 = "arith.constant"() <{"value" = 4 : index}> : () -> index
...
//CHECK-NEXT:     %9 = "arith.constant"() <{"value" = 2 : index}> : () -> index
//CHECK-NEXT:     "scf.for"(%6, %9, %7) ({
//CHECK-NEXT:     ^1(%10 : index):
//CHECK-NEXT:       %11 = "arith.constant"() <{"value" = 16 : index}> : () -> index
//CHECK-NEXT:       %12 = "arith.muli"(%10, %11) : (index, index) -> index
//CHECK-NEXT:       %13 = "arith.addi"(%0, %12) : (index, index) -> index
//CHECK-NEXT:       %14 = "arith.constant"() <{"value" = 64 : index}> : () -> index
//CHECK-NEXT:       %15 = "arith.muli"(%10, %14) : (index, index) -> index
//CHECK-NEXT:       %16 = "arith.addi"(%1, %15) : (index, index) -> index
//CHECK-NEXT:       "scf.for"(%6, %8, %7) ({
//CHECK-NEXT:       ^2(%17 : index):
//CHECK-NEXT:         %18 = "arith.constant"() <{"value" = 128 : index}> : () -> index
//CHECK-NEXT:         %19 = "arith.muli"(%17, %18) : (index, index) -> index
//CHECK-NEXT:         %20 = "arith.addi"(%13, %19) : (index, index) -> index
//CHECK-NEXT:         %21 = "arith.constant"() <{"value" = 128 : index}> : () -> index
//CHECK-NEXT:         %22 = "arith.muli"(%17, %21) : (index, index) -> index
//CHECK-NEXT:         %23 = "arith.addi"(%16, %22) : (index, index) -> index
//CHECK-NEXT:         "func.call"(%20, %23, %2, %3, %4, %5) <{"callee" = @snax_dma_2d_transfer}> : (index, index, index, index, index, index) -> ()
