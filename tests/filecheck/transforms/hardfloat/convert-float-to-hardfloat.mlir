...
func.func @test_hardfloat(%a : f32, %b : f32) -> (f32, f32) {
  %add = arith.addf %a, %b : f32
  %mul = arith.mulf %a, %b : f32
  return %add, %mul : f32, f32
}

// CHECK: func.func @test_hardfloat(%a : f32, %b : f32) -> (f32, f32) {
...
// CHECK-NEXT:   func.return %add_6, %mul_6 : f32, f32
// CHECK-NEXT: }
