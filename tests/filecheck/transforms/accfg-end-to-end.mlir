...
// CHECK-NEXT:     "llvm.inline_asm"(%4, %arg0) <{asm_string = "csrw $0, $1", constraints = "I, rK", asm_dialect = 0 : i64, has_side_effects, tail_call_kind = #llvm.tailcallkind<none>}> : (i64, i32) -> ()
// CHECK-NEXT:     %5 = arith.constant 980 : i64
// CHECK-NEXT:     "llvm.inline_asm"(%5, %0) <{asm_string = "csrw $0, $1", constraints = "I, rK", asm_dialect = 0 : i64, has_side_effects, tail_call_kind = #llvm.tailcallkind<none>}> : (i64, i32) -> ()
...
// CHECK-NEXT:       "llvm.inline_asm"(%8, %6) <{asm_string = "csrw $0, $1", constraints = "I, rK", asm_dialect = 0 : i64, has_side_effects, tail_call_kind = #llvm.tailcallkind<none>}> : (i64, i32) -> ()
// CHECK-NEXT:       %9 = arith.constant 979 : i64
// CHECK-NEXT:       "llvm.inline_asm"(%9, %7) <{asm_string = "csrw $0, $1", constraints = "I, rK", asm_dialect = 0 : i64, has_side_effects, tail_call_kind = #llvm.tailcallkind<none>}> : (i64, i32) -> ()
// CHECK-NEXT:       %10 = arith.constant 960 : i64
// CHECK-NEXT:       "llvm.inline_asm"(%10, %0) <{asm_string = "csrw $0, $1", constraints = "I, K", asm_dialect = 0 : i64, has_side_effects, tail_call_kind = #llvm.tailcallkind<none>}> : (i64, i32) -> ()
// CHECK-NEXT:       scf.while () : () -> () {
// CHECK-NEXT:         %11 = arith.constant 963 : i64
// CHECK-NEXT:         %12 = arith.constant 0 : i32
// CHECK-NEXT:         %13 = "llvm.inline_asm"(%11) <{asm_string = "csrr $0, $1", constraints = "=r, I", asm_dialect = 0 : i64, has_side_effects, tail_call_kind = #llvm.tailcallkind<none>}> : (i64) -> i32
...
// CHECK-NEXT:       "llvm.inline_asm"(%15, %16) <{asm_string = "csrw $0, $1", constraints = "I, K", asm_dialect = 0 : i64, has_side_effects, tail_call_kind = #llvm.tailcallkind<none>}> : (i12, i5) -> ()
