...
func.func public @simple_mult(%arg0 : memref<?xi32>, %arg1 : memref<?xi32>, %arg2 : memref<?xi32>) {
  ...
  %6 = "accfg.launch"(%cst_0, %5) <{"param_names" = ["launch"], "accelerator" = "snax_hwpe_mult"}> : (i5,!accfg.state<"snax_hwpe_mult">) -> !accfg.token<"snax_hwpe_mult">
  ...
  %8, %9 = "scf.if"(%7) ({
    ...
    %11 = "accfg.launch"(%cst_0, %10) <{"param_names" = ["launch"], "accelerator" = "snax_hwpe_mult"}> : (i5,!accfg.state<"snax_hwpe_mult">) -> !accfg.token<"snax_hwpe_mult">
  ...
  %17 = "accfg.launch"(%cst_0, %16) <{"param_names" = ["launch"], "accelerator" = "snax_hwpe_mult"}> : (i5,!accfg.state<"snax_hwpe_mult">) -> !accfg.token<"snax_hwpe_mult">
  ...
  %res_1 = scf.for %iv = %lb to %ub step %step iter_args(%inner_state = %16) -> (!accfg.state<"snax_hwpe_mult">) {
    ...
    %222 = "accfg.launch"(%cst_0, %s_new) <{"param_names" = ["launch"], "accelerator" = "snax_hwpe_mult"}> : (i5,!accfg.state<"snax_hwpe_mult">) -> !accfg.token<"snax_hwpe_mult">
...
// CHECK-NEXT:     %17 = "accfg.launch"(%cst_0, %9) <{"param_names" = ["launch"], "accelerator" = "snax_hwpe_mult"}> : (i5, !accfg.state<"snax_hwpe_mult">) -> !accfg.token<"snax_hwpe_mult">
...
// CHECK-NEXT:      }
// CHECK-NEXT:      scf.yield %31 : !accfg.state<"simple">
// CHECK-NEXT:    }
// CHECK-NEXT:    func.return
// CHECK-NEXT:  }
