...
// CHECK-NEXT:     }) {"library_call" = "snax_qgemm"} : (memref<?x128xi8, #tsl.tsl<[?, 8] -> (?, 8), [?, 8] -> (256, 1)>, 1 : i32>, memref<128x128xi8, #tsl.tsl<[?, 8] -> (256, 1), [?, 8] -> (?, 8)>, 1 : i32>, i32, i32, memref<?x128xi32, #tsl.tsl<[?, 8] -> (?, 32), [?, 8] -> (256, 4)>, 1 : i32>) -> ()
