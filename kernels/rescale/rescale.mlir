"builtin.module"() ({
  ...
  ^bb0(%arg0: memref<16x16xi32>, %arg1: memref<16x16xi8>):
    ...
    ^bb0(%arg2: i32, %arg3: i8):
      %0 = "kernel.rescale"(%arg2) {double_round = true, input_zp = 23 : i8, max_int = 100 : i8, min_int = -110 : i8, multiplier = array<i32 : 1234567890>, output_zp = -15 : i8, shift = array<i8 : 39>} : (i32) -> i8
      "linalg.yield"(%0) : (i8) -> ()
