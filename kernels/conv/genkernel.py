...
def generate_conv_ir(spec: ConvSpec):
    # cop
    low_bound = 0
    high_bound = 10

    I_size = [spec.b, spec.c, spec.oy + spec.fy - 1, spec.ox + spec.fx - 1]
    ...
    input_type = builtin.TensorType(i8, (spec.b, spec.c, spec.oy + spec.fy - 1, spec.ox + spec.fx - 1))
    kernel_type = builtin.TensorType(i8, (spec.k, spec.c, spec.fy, spec.fx))
    output_type = builtin.TensorType(i32, (spec.b, spec.c, spec.oy, spec.ox))
