...
func.func public @simple_mult(%A: memref<64xi32, "L3">,
    ...
    "scf.if"(%is_dm_core) ({
      ...
      "memref.copy"(%A, %A_L1) : (memref<64xi32, "L3">, memref<64xi32, "L1">) -> ()
      "memref.copy"(%B, %B_L1) : (memref<64xi32, "L3">, memref<64xi32, "L1">) -> ()
      ...
      "memref.copy"(%D_L1, %D) : (memref<64xi32, "L1">, memref<64xi32, "L3">) -> ()
      "snax.cluster_sync_op"() : () -> ()
      scf.yield
    },{
    ...
    "scf.if"(%is_compute_core) ({
      ...
      ins(%A_L1, %B_L1: memref<64xi32, "L1">, memref<64xi32, "L1">)
      outs(%D_L1: memref<64xi32, "L1">) {
