...
func.func public @simple_mult(%A: memref<64xi32, 0 : i32>,
    ...
    "scf.if"(%is_dm_core) ({
      ...
      %tiled_D = "memref.subview"(%D, %c64) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (memref<64xi32, 0: i32>, index) -> memref<?xi32, strided<[1]>, 0: i32>
      %tiled_D_L1 = "memref.subview"(%D_L1, %c64) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (memref<64xi32, 1: i32>, index) -> memref<?xi32, strided<[1]>, 1: i32>
